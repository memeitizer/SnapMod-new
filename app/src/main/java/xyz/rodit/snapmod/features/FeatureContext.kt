...
private const val ANTI_AUTO_SAVE_FILE = "anti_auto_save.list"
...
class FeatureContext(
    ...
    val anti_autoSave: ConversationManager = ConversationManager(appContext.filesDir, ANTI_AUTO_SAVE_FILE)
